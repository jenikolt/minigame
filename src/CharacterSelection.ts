...
export class CharacterSelection extends Phaser.Scene {
    fon: Phaser.Sound.BaseSound | undefined;
    constructor() {
    ...
    preload() {
        ...
        this.load.audio('fon', 'src/assets/fon.mp3');
        this.load.audio('openPivo', 'src/assets/openPivo.mp3');
    }
    ...
    create() {
        ...
        this.fon = this.sound.add('fon').setVolume(0.3);
        this.fon.play();
        ...
        characters.forEach((character, index) => {
            ...
            characterSprite.on('pointerdown', () => {
                this.fon?.stop();
                this.sound.add('openPivo').setVolume(0.3).play();
